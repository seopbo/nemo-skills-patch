...
def process_file(input_file: Path, output_file: Path, model_path: str, batch_size: int = 4):
    ...
    comet_scores = model.predict(comet_list, batch_size, gpus=1).scores
...
def main():
    ...
    for input_file, output_file in files_to_process:
        process_file(input_file, output_file, args.comet_model)
