...
# Run GPU tests
pytest tests/gpu-tests/

# Run specific test
pytest tests/test_sandbox_network_blocking.py
```
...
Scripts reference each other for coordination (e.g., client gets server hostname/port automatically).
...
- Use `ns <command> --help` to see available arguments
