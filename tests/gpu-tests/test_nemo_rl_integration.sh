...
# Use chat completions - temperature/top_p are passed through from incoming requests
# so the vLLM assertion (request.temperature == generation_config["temperature"]) passes
