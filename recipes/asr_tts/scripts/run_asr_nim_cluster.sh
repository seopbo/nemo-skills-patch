...
# Example script for ASR transcription using Riva NIM on cluster
# This script uses test data from tests/slurm-tests/asr_nim/
# The test data is automatically packaged and available at /nemo_run/code/ on the cluster
...
CLUSTER=$1
WORKSPACE=$2
CONTAINER=${3:-nvcr.io/nim/nvidia/parakeet-tdt-0.6b-v2:1.0.0}
...
OUTPUT_DIR=/workspace/asr_outputs  # Relative to the mounted workspace
